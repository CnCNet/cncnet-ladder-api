                ...
                @foreach($maps as $map)
                    <div class="row map hidden" id="map_{{$map->id == 0 ? 'new': $map->id }}">
                        ...
                        <div class="form-group col-md-4" >
                            ...
                            <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#editOptions_{{$map->id}}"> Edit </button>
                            <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#newOptions_{{$map->id}}"> New </button>
                        </div>
                    </div>
                @endforeach
            </div>
