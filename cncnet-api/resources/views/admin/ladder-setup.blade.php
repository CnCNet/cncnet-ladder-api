...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="player-box player-card" style="margin-bottom: 8px">
                                    ...
                                    @if ($user->isGod())
                                        <form method="POST" action="add/admin">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="text" id="email" name="email" class="form-control" placeholder="newAXdmin@email.com" />
                                ...
                                <div class="player-box player-card" style="margin-bottom: 8px">
                                    ...
                                    @if ($user->isGod() || $user->isLadderAdmin($ladder))
                                        <form method="POST" action="add/moderator">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="text" id="email" name="email" class="form-control" placeholder="newMod@email.com" />
                                            <button type="submit" class="btn btn-primary btn-sm">Add</button>
                                        </form>
                                    @endif
                                </div>
                                ...
                                <div class="player-box player-card" style="margin-bottom: 8px">
                                    ...
                                    @if ($user->isGod() || $user->isLadderAdmin($ladder) || $user->isLadderMod($ladder))
                                        <form method="POST" action="add/tester">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="text" id="email" name="email" class="form-control" placeholder="newTester@email.com" />
                                            <button type="submit" class="btn btn-primary btn-sm">Add</button>
                                        </form>
                                    @endif
                                </div>
                                ...
                                @if ($user->isGod() || $user->isLadderAdmin($ladder))
                                    <div class="player-box player-card" style="margin-bottom: 8px">
                                        ...
                                        <button type="button" class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#editAlert">Edit </button>
                                    </div>
                                @endif
                                ...
                                <div class="player-box player-card" style="margin-bottom: 8px">
                                    ...
                                    <form method="POST" action="addSide">
                                        ...
                                        <div class="form-group col-md-4" style="padding-left: 0;">
                                            ...
                                            <input id="local_id" name="local_id" type="number" maxlength="3" size="3" class="form-control" style="font-size: 8px"
                            ...
                            <div class="col-md-3">
                                <div class="player-box player-card" style="margin-bottom: 8px">
                                    ...
                                    <button type="button" class="btn btn-secondary btn-md" data-toggle="modal" data-target="#newMapPool"> New </button>
                                    <button type="button" class="btn btn-secondary btn-md" id="doClone" data-toggle="modal" data-target="#cloneMapPool"> Clone </button>
                                </div>
                                ...
                                <?php
                                $new_sov = new \App\SpawnOptionValue();
                                $new_sov->id = 'new';
                                $new_sov->value = '';
                                ?>
                                @include('admin.spawn-option', [
    ...
    <div class="modal" id="editAlert" tabIndex="-1" role="dialog">
