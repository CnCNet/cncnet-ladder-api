    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navigation-links">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="status" class="dropdown-toggle status-cncnet status-text hidden-md" data-toggle="dropdown" role="button"
                        aria-haspopup="true" aria-expanded="false">Players Online <span class="online">...</span> <span class="caret"></span></a>
                    <ul class="dropdown-menu status-games">
                        ...
                        <li class="game-status status-yr"><a href="//cncnet.org/yuris-revenge">Yuri's Revenge <span class="online">999</span></a>
                        </li>
