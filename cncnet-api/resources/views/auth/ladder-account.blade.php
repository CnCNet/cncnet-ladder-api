            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="username">
                        ...
                        @if ($ladder->clans_allowed)
                            <p>
                                <strong>Do not include clan names in your usernames. This will happen
                            ...
                            <div class="col-md-12 player-box player-card" style="padding:8px;margin:8px;">
                                <div class="account-box">
                                    ...
                                    <form method="POST" action="username">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <input type="hidden" name="ladder" value="{{ $ladder->id }}">
                                        <p>Player usernames will be the name shown when you login to CnCNet clients and
                                            play games.
                                        </p>
