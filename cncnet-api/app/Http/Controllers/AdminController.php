...
class AdminController extends Controller
{
    ...
    public function awardedPointsPreview(GameReport $gameReport, LadderHistory $history): array
    {
        ...
        $pointService = new \App\Http\Services\PointService();
        ...
        $winnerRating = (new \App\Http\Services\PlayerService())->findUserRatingByPlayerId($winner->player_id);
        $loserRating = (new \App\Http\Services\PlayerService())->findUserRatingByPlayerId($loser->player_id);
