...
Route::group(['prefix' => 'admin/', 'middleware' => 'auth', 'canAdminLadder' => true], function ()
{
    ...
    Route::post('players/ratings/{ladderAbbreviation}/reset/reset-player-rating', 'AdminController@resetPlayerRating');
});
...
Route::group(['prefix' => 'api/v1/', 'middleware' => 'cache.short.public'], function ()
{
    ...
    Route::get('/qm/ladder/{ladderAbbrev}/errored/games', 'ApiQuickMatchController@getErroredGames');
});
