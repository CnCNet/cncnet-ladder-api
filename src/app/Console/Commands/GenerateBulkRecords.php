...
class GenerateBulkRecords extends Command
{
    ...
    public function handle()
    {
        ...
        $histories = LadderHistory::where('short', '=', $month . "-" . $year)->get();
        ...
        foreach ($histories as $history)
        {
            ...
            Game::where('ladder_history_id', '=', $history->id)->whereNotNull('game_report_id')->chunk(2000, function ($games) use (&$history, &$ladders)
            {
