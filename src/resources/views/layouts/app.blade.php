...
<head>
    ...
    <link rel="stylesheet" href="/css/ladder.css?v=2.91" />
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="//forums.cncnet.org"
                                title="{{ trans('footer.footer_support') }}">{{ trans('footer.footer_support') }}</a>
                        </li>
                        <li><a href="developers"
                                title="{{ trans('footer.footer_irc') }}">{{ trans('footer.footer_irc') }}</a></li>
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-inline">
                        <li><a href="http://facebook.com/cncnet" title="Follow CnCNet on Facebook" target="_blank"><i
                                    class="fa fa-facebook fa-2x fa-fw"></i></a></li>
                        <li><a href="http://twitter.com/cncnetofficial" title="Follow CnCNet on Twitter"
                                target="_blank"><i class="fa fa-twitter fa-2x fa-fw"></i></a></li>
                        <li><a href="https://www.youtube.com/user/CnCNetOfficial?sub_confirmation=1"
                                title="Subscribe to CnCNet on YouTube" target="_blank"><i
                                    class="fa fa-youtube fa-2x fa-fw"></i></a></li>
                        <li><a href="https://reddit.com/r/cncnet" title="Subscribe to CnCNet on Reddit"
                                target="_blank"><i class="fa fa-reddit fa-2x fa-fw"></i></a> </li>
                        <li><a href="https://www.twitch.tv/cncnetofficial" title="Subscribe to CnCNet on Twitch"
                                target="_blank"><i class="fa fa-twitch fa-2x fa-fw"></i></a></li>
                        <li><a href="https://github.com/cncnet" title="Follow and Star us on GitHub" target="_blank"><i
                                    class="fa fa-github fa-2x fa-fw"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-md-offset-6">
                    <ul class="list-inline partners text-right">
                        <li>
                            <a href="http://gamesurge.net" target="_blank" title="GameSurge"><img
                                    src="/images/gamesurge.png" alt="GameSurge Logo" width="200" /></a>
                        </li>
                        <li><img src="/images/logo.png" width="200" alt="CnCNet Logo" /></li>
                    </ul>
                    <ul class="list-inline text-right">
                        <li><a href="//cncnet.org/privacy-policy"
                                title="{{ trans('footer.footer_privacy_policy') }}">{{ trans('footer.footer_privacy_policy') }}</a>
                        </li>
                        <li><a href="//cncnet.org/terms-and-conditions"
                                title="{{ trans('footer.footer_terms_conditions') }}">{{ trans('footer.footer_terms_conditions') }}</a>
                        </li>
