                            ...
                            <div class="col-md-3">
                                <div class="player-box player-card" style="margin-bottom: 8px">
                                    ...
                                    <div style="overflow-x: auto">
                                        @foreach ($ladder->admins()->where('admin', '=', true)->get()
        as $admin)
                                                ...
                                                <form method="POST" action="remove/admin">
                                                    ...
                                                    @if ($user->isGod())
                                                        <button type="submit" id="remove_admin_{{ $admin->id }}"
                                                            style="margin: 0 0" class="btn btn-link btn-sm"
                                                            data-toggle="tooltip" data-placement="top" title="Remove">
                                                            <span class="fa fa-times fa-lg clan-danger"></span>
                                                        </button>
                                                    @endif
                                                    <span style="overflow: hidden;"
                                                        @if ($user->isGod()) data-toggle="tooltip" data-placement="bottom" title="{{ $admin->user->email }}" @endif>{{ $admin->user->name }}</span>
                                                </form>
                                            </div>
                                        @endforeach
                                    </div>
                                    @if ($user->isGod())
                                        <form method="POST" action="add/admin">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="text" id="email" name="email" placeholder="newAXdmin@email.com" />
                                ...
                                <div class="player-box player-card" style="margin-bottom: 8px">
                                    ...
                                    <div style="overflow-x: auto">
                                        @foreach ($ladder->moderators()->where('moderator', '=', true)->where('admin', '=', false)->get()
        as $mod)
                                            <div style="white-space: nowrap;">
                                                <form method="POST" action="remove/moderator">
                                                    ...
                                                    @endif
                                                    <span style="overflow: hidden;"
                                                        @if ($user->isGod() || $user->isLadderAdmin($ladder)) data-toggle="tooltip" data-placement="bottom" title="{{ $mod->user->email }}" @endif>{{ $mod->user->name }}</span>
                                                </form>
                                            </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="player-box player-card" style="margin-bottom: 8px">
                                    ...
                                    <div style="overflow-x: auto">
                                        @foreach ($ladder->testers()->where('tester', '=', true)->where('admin', '=', false)->where('moderator', '=', false)->get()
        as $tester)
                                            <div style="white-space: nowrap;">
                                                <form method="POST" action="remove/tester">
                                                    ...
                                                    @endif
                                                    <span style="overflow: hidden;"
                                                        @if ($user->isGod() || $user->isLadderAdmin($ladder) || $user->isLadderMod($ladder)) data-toggle="tooltip" data-placement="bottom" title="{{ $tester->user->email }}" @endif>{{ $tester->user->name }}</span>
                                                </form>
                                            </div>
                                        @endforeach
                                    </div>
                                ...
                                @if ($user->isGod() || $user->isLadderAdmin($ladder))
                                    <div class="player-box player-card" style="margin-bottom: 8px">
                                        ...
                                        <button type="button" class="btn btn-primary btn-md" data-toggle="modal"
                                            data-target="#editAlert">Edit </button>
                                    </div>
                                @endif
                                    ...
                                    <form method="POST" action="ladder">
                                        ...
                                        <div class="form-group col-md-6" style="padding-left: 0;">
                                            ...
                                            <input id="ladder_abbreviation" name="abbreviation" type="text"
                                                class="form-control" value="{{ $ladder->abbreviation }}" />
                                        </div>
                                    ...
                                    <form method="POST" action="remSide">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="sides" name="local_id" class="form-control">
                                                @foreach ($ladder->sides()->orderBy('local_id', 'ASC')->get()
        as $side)
                            ...
                            <div class="col-md-3">
                                <div class="player-box player-card" style="margin-bottom: 8px">
                                    <form method="POST" action="mappool">
                                            ...
                                            <select id="mapPoolSelector" name="map_pool_id" class="form-control">
                                                ...
                                                @foreach ($mapPools as $pool)
                                                    @if ($pool->id == $ladder->map_pool_id)
                                                        <option value="{{ $pool->id }}" selected>{{ $pool->name }}
                                                        </option>
                                                    @else
                                        ...
                                        <a type="button" class="btn btn-primary btn-md" id="editMapPool"
                                            href="mappool/{{ $ladder->map_pool_id }}/edit">Edit</a>
                                    </form>
                                    <button type="button" class="btn btn-primary btn-md" data-toggle="modal"
                                        data-target="#newMapPool"> New </button>
                                    <button type="button" class="btn btn-primary btn-md" id="doClone" data-toggle="modal"
                                        data-target="#cloneMapPool"> Clone </button>
                                </div>
                                        ...
                                        <form method="POST" action="rules">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="{{ $rule->ladder_id }}_player_count" type="number"
                                                    name="player_count" class="form-control"
                                                    value="{{ $rule->player_count }}" />
                                            </div>

                                            <div class="form-group">
                                                <label for="{{ $rule->ladder_id }}_map_vetoes">Map Vetoes</label>
                                                <input id="{{ $rule->ladder_id }}_map_vetoes" type="number"
                                                    name="map_vetoes" class="form-control"
                                                    value="{{ $rule->map_vetoes }}" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="{{ $rule->ladder_id }}_difference" type="number"
                                                    name="max_difference" class="form-control"
                                                    value="{{ $rule->max_difference }}" />
                                            </div>

                                            <div class="form-group">
                                                <label for="{{ $rule->ladder_id }}_rating_per_second">Filter - rating per
                                                    q-second</label>
                                                <input id="{{ $rule->ladder_id }}_rating_per_second" type="number"
                                                    step="0.05" name="rating_per_second" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="{{ $rule->ladder_id }}_point_difference" type="number"
                                                    name="max_points_difference" class="form-control"
                                                    value="{{ $rule->max_points_difference }}" />
                                            </div>

                                            <div class="form-group">
                                                <label for="{{ $rule->ladder_id }}_points_per_second">Filter - points per
                                                    q-second</label>
                                                <input id="{{ $rule->ladder_id }}_points_per_second" type="number"
                                                    step="0.05" name="points_per_second" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="show_map_preview" name="show_map_preview"
                                                    class="form-control">
                                                    <option value="1" @if ($rule->show_map_preview) selected @endif>Yes
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="{{ $rule->use_elo_points }}_use_elo_points" type="number"
                                                    min="0" max="1" name="use_elo_points" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="{{ $rule->wol_k }}_use_elo_points" type="number" min="0"
                                                    name="wol_k" class="form-control" value="{{ $rule->wol_k }}" />
                                            </div>

                                            <div class="form-group">
                                                <label for="{{ $rule->ladder_id }}_bail_fps">Bail FPS</label>
                                                <input id="{{ $rule->ladder_id }}_bail_fps" type="number" name="bail_fps"
                                                    class="form-control" value="{{ $rule->bail_fps }}" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="{{ $rule->ladder_id }}_tier2_rating" type="number"
                                                    name="tier2_rating" class="form-control"
                                                    value="{{ $rule->tier2_rating }}" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="{{ $rule->ladder_id }}_sides" name="all_sides" type="text"
                                                    class="form-control" value="{{ $rule->all_sides }}" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="{{ $rule->ladder_id }}_reduce_map_repeats" min="0"
                                                    type="number" name="reduce_map_repeats" class="form-control"
                                                    ...
                                                    @foreach ($sides as $side)
                                                        <div>
                                                            <input id="side_{{ $side->id }}" type="checkbox"
                                                                name="allowed_sides[]" value="{{ $side->local_id }}"
                                                                @if (in_array($side->local_id, $sideIdsAllowed)) checked @endif />
                                                            <label
                                                                for="side_{{ $side->id }}">{{ $side->name }}</label>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="player-box player-card">
                                        <form method="POST" action="rules">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-lg">Enable QuickMatch</button>
                                        </form>
                                    </div>
                                </div>
                            @endif
                        ...
                        <div class="row">
                            <div class="col-md-12 player-box player-card" style="padding:8px;margin:8px;">
                                <form method="POST" action="mappool/new">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    <input type="hidden" name="id" value="new" <input type="hidden" name="ladder_id"
                                        value="{{ $ladder->id }}" />
                                    <div class="form-group">
                                        <label for="map_pool_name"> Map Pool</label>
                                        <input type="text" id="map_pool_name" name="name" value=""
                                            class="form-control" />
