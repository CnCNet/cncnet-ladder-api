            ...
            <div class="container">
                ...
                <div class="row">
                    <a class="btn btn-sm btn-primary"
                        href="/admin/moderate/{{ $player->ladder->id }}/player/{{ $player->id }}/newban/{{ \App\Models\Ban::COOLDOWN1H }}">1
                        Hour Cooldown</a>
                    <a class="btn btn-sm btn-primary"
                        href="/admin/moderate/{{ $player->ladder->id }}/player/{{ $player->id }}/newban/{{ \App\Models\Ban::COOLDOWN2H }}">2
                        Hour Cooldown</a>
                    <a class="btn btn-sm btn-primary"
                        href="/admin/moderate/{{ $player->ladder->id }}/player/{{ $player->id }}/newban/{{ \App\Models\Ban::COOLDOWN4H }}">4
                        Hour Cooldown</a>
                    <a class="btn btn-sm btn-primary"
                        href="/admin/moderate/{{ $player->ladder->id }}/player/{{ $player->id }}/newban/{{ \App\Models\Ban::COOLDOWN12H }}">12
                        Hour Cooldown</a>
                    <a class="btn btn-sm btn-danger"
                        href="/admin/moderate/{{ $player->ladder->id }}/player/{{ $player->id }}/newban/{{ \App\Models\Ban::BAN48H }}">48
                        Hour Ban</a>
                    <a class="btn btn-sm btn-danger"
                        href="/admin/moderate/{{ $player->ladder->id }}/player/{{ $player->id }}/newban/{{ \App\Models\Ban::BAN1WEEK }}">1
                        Week Ban</a>
                    <a class="btn btn-sm btn-danger"
                        href="/admin/moderate/{{ $player->ladder->id }}/player/{{ $player->id }}/newban/{{ \App\Models\Ban::BAN2WEEK }}">2
                        Week Ban</a>
                    @if (isset($mod) && $mod->isLadderAdmin($player->ladder))
                        <a class="btn btn-sm btn-danger"
                            href="/admin/moderate/{{ $player->ladder->id }}/player/{{ $player->id }}/newban/{{ \App\Models\Ban::PERMBAN }}">Indefinite
                            Ban</a>
                    @endif
                </div>
            </div>
