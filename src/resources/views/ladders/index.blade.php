                    ...
                    <div class="row">
                        @foreach ($ladderWinners['players'] as $k => $player)
                            ...
                            <div class="col-xs-12 col-md-6">
                                <h4><a href="/ladder-champions/{{ $ladderWinners['abbreviation'] }}">View All</a>
                                ...
                                <a href="{{ $url }}" title="View {{ $player->player_name }}'s profile">
                                    <div class="ladder-cover cover-{{ $history->ladder->abbreviation ?? '' }}"
                                        ...
                                        <div class="details tier-league-cards">
                                            <div class="type">
                                                <h1 class="lead"><strong>{{ $player->player_name }}</strong>
                                                </h1>
                                                ...
                                                @endif
                                                <strong>{{ $date->format('m/Y') }}</strong>
                                                {{ $ladderWinners['full'] }} Ladder</small>
                                            </div>
                                        </div>
                                    </div>
                                </a>
