                                ...
                                <div class="ladder-cover cover-{{ $history->ladder->abbreviation }}"
                                    ...
                                    <div class="details tier-league-cards">
                                        <div class="type">
                                            ...
                                            @endif
                                            <strong>{{ $date->format('m/Y') }}</strong> {{ $history->abbreviation }}
                                            League</small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="header">
                        <div class="col-md-12">
                            <h3><strong>1vs1</strong> Recent Games
                                <small>
                                    <a
                                        href="{{ '/ladder/' . $history->short . '/' . $history->ladder->abbreviation . '/games' }}">View
                                        All Games</a>
                                </small>
                            </h3>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 text-right">
                                    <ul class="list-inline">
                                        <li>
                                            <a href="/account/{{ $history->ladder->abbreviation }}/list"
                                                class="btn btn-secondary text-uppercase" style="font-size: 15px;">
                                                <i class="fa fa-user fa-lg fa-fw" aria-hidden="true"
                                                    style="margin-right: 0;"></i> Your Account
                                            </a>
                                        </li>
                                        <li>
                                            <button class="btn btn-secondary text-uppercase" data-toggle="modal"
                                                data-target="#battleRanks" style="font-size: 15px;">
                                                <i class="fa fa-trophy fa-lg fa-fw" aria-hidden="true"
                                                    style="margin-right: 5px;"></i> Battle Ranks
                                            </button>
                                        </li>
                                        <li>
                                            <div class="btn-group filter">
                                                <button type="button"
                                                    ...
                                                    <i class="fa fa-industry fa-fw" aria-hidden="true"
                                                        style="margin-right: 5px;"></i> Previous Month <span
                                                        class="caret"></span>
                                                </button>
                                                ...
                                                <div class="form-group" method="GET">
                                                    <div class="search" style="position:relative;">
                                                        ...
                                                        <input class="form-control" name="search"
                                                            value="{{ $search }}" placeholder="Player username..."
                                    ...
                                    <div class="text-right">
                                        @if ($search)
                                            <small>
                                                Searching for <strong>{{ $search }}</strong> returned
                                                {{ count($players) }} results
                        ...
                        <div class="row">
                            @foreach ($players as $k => $player)
                                ...
                                if ($history->ladder->game == 'yr') {
                                    $side = \App\Models\Side::where('local_id', $player->country)
                                ...
                                <div class="col-md-4">
                                    @include('components/player-box', [
                                        ...
                                        'badge' => \App\Models\Player::getBadge($player->percentile),
                                        'rank' => $rank,
                                        'wins' => $player->wins,
                                        'totalGames' => $player->games,
                                        'playerCard' =>
                                            $player->card !== null ? (array_key_exists($player->card, $cards) ? $cards[$player->card + 0] : '') : '',
                                        'side' => $countryName,
            ...
            <div class="modal-content">
                ...
                <div class="modal-body clearfix text-center">
                    ...
                    @foreach ($pecentiles as $percentile)
                        <?php $badge = \App\Models\Player::getBadge($percentile); ?>
