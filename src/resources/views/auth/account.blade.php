                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center" style="padding-bottom: 40px;">
                            <h1>Hi {{ $user->name }} <button class="btn btn-link inline-after-edit" data-toggle="modal"
                                    data-target="#renameUser"><span class="fa fa-edit"></span></button></h1>
                                ...
                                <div class="ladder-cover cover-{{ $history->ladder->abbreviation }}"
                                    ...
                                    <div class="badge-cover">
                                        <ul class="list-inline">
                                            <li>
                                                <p>{{ Carbon\Carbon::parse($history->starts)->format('F Y') }} Competition
                                                </p>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <a href="/account/{{ $history->ladder->abbreviation }}/list"
                                ...
                                <div class="ladder-cover cover-{{ $history->ladder->abbreviation }}"
                                    ...
                                    <div class="badge-cover">
                                        <ul class="list-inline">
                                            <li>
                                                <p>{{ Carbon\Carbon::parse($history->starts)->format('F Y') }}
                                                    Competition</p>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <form method="POST" action="/account/rename">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name"
                                                placeholder="New Username" value="{{ $user->name }}">
                                        </div>
